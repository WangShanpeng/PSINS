function [ir, dist] = trirreg(xyz, L10, isfig)
...
% 04/03/2024
    ...
    len = length(dis); iL10=1; iL5=1; ir=zeros(len,2); dist=zeros(len,3);
    for k=1:len
...
%     ir = no0([abs(ir)/L10, dis],1:2);
    ...
    if isfig==1
        ...
        xygo('distance / m', sprintf('irregularity / m (L=%.0fm)',L10));  legend('level', 'height');
    end
