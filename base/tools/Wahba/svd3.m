...
% 01/02/2016
    ...
    b1 = B(1,1)*(B(2,2)+B(3,3))+B(2,2)*B(3,3)-B(2,3)^2-B(1,2)^2-B(1,3)^2;
    c1 = -(B(1,1)*(B(2,2)*B(3,3)-B(2,3)^2)+B(1,2)*(-B(1,2)*B(3,3)+2*B(1,3)*B(2,3))-B(1,3)^2*B(2,2));  
    [rs, state] = roots3([1;a;b;c]);
    rs1 = roots3([1;a;b1;c1]);
