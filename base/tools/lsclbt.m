...
% Inputs: wbib - SIMU gyro angular rate, yw - turntable angular rate,
%         fbsf - SIMU acc specific force, yf - turntable specific force.
% Outputs: Kg, eb, Ka, db - calibration results,
%
% See also  sysclbt.
