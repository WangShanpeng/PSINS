% POS and data fusion simulation. A 34-state Kalman filter is used, 
...
gps = gpssimu(trj.avp, davp0(4:6), davp0(7:9), 3, lever, dT, 1);
...
err = [imuerr.eb;imuerr.db;lever;dT;imuerr.dKga]'*0;
