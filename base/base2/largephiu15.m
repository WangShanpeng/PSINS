...
global glv
    ...
    ddpos = [ dvn0(2)/ins.eth.RMh-ins.vn(2)*dpos0(3)/ins.eth.RMh^2;
        ...
        dvn0(3) ];
    Xk = Xkk_1 + [dphi; ddvn; ddpos; zeros(6,1)]*ins.nts; 
